...
export const PaymentModal: React.FC<PaymentModalProps> = ({    qrCodeURL,
    ...
    useEffect(() => {
        const interval = setInterval(async () => {
            try {
                const orderResult = await getOrder({orderId: orderId});
    ...
    return (
        ...
        >
            <Row align="middle">
                <span style={{ fontSize: '16px', fontWeight: 'bold' }}>订单号: {orderId}</span>
            </Row>
            <Row align="middle">
...
interface RenewalModalProps {
    serviceInstanceModel: API.ServiceInstanceModel;
    qrCodeURL: string;
    orderId: string;
    orderAmount: number;
    onClose: () => void;
...
export const RenewalModal: React.FC<RenewalModalProps> = ({ serviceInstanceModel,
                                                       qrCodeURL,
                                                       orderId,
                                                       orderAmount,
                                                       onClose,
