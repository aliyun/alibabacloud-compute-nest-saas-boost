...
public class CommoditySpecificationOtsHelper {
    ...
    public CommoditySpecificationDTO getCommoditySpecification(String commodityCode, String specificationCode) {
        PrimaryKey primaryKey = createPrimaryKey(commodityCode, specificationCode);
    ...
    public Boolean deleteCommoditySpecification(String commodityCode, String specificationCode) {
        PrimaryKey primaryKey = createPrimaryKey(commodityCode, specificationCode);
