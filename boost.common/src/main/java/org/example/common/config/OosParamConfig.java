...
public class OosParamConfig {
    ...
    public void init() {
        ...
        putValue(OOS_WECHATPAY_PID);
        putSecretValue(OOS_SECRET_WECHATPAY_API_KEY);
        putSecretValue(OOS_SECRET_WECHATPAY_CERT_PATH);
        putSecretValue(OOS_SECRET_WECHATPAY_APP_CERT_PATH);
        putSecretValue(OOS_SECRET_WECHATPAY_PLATFORM_CERT_PATH);
        ...
        modifiableParameterList.add(OOS_WECHATPAY_PID);
        modifiableParameterList.add(OOS_SECRET_WECHATPAY_API_KEY);
        modifiableParameterList.add(OOS_WECHATPAY_GATEWAY);
        modifiableParameterList.add(OOS_SECRET_WECHATPAY_CERT_PATH);
        modifiableParameterList.add(OOS_SECRET_WECHATPAY_APP_CERT_PATH);
        modifiableParameterList.add(OOS_SECRET_WECHATPAY_PLATFORM_CERT_PATH);
    }
