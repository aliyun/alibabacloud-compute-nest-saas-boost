...
public class OosParamConfig {
    ...
    public void init() {
        ...
        List<String> secretValueList = Arrays.asList(
                OAUTH_CLIENT_ID,
                OOS_SECRET_ADMIN_AID,
                OAUTH_CLIENT_SECRET,
                OOS_SECRET_ALIPAY_OFFICIAL_PUBLIC_KEY,
                OOS_SECRET_ALIPAY_PRIVATE_KEY,
                OOS_SECRET_ALIPAY_APP_CERT_PATH,
                OOS_SECRET_ALIPAY_CERT_PATH,
                OOS_SECRET_ALIPAY_ROOT_CERT_PATH,
                OOS_SECRET_WECHATPAY_APIV3_KEY,
                OOS_SECRET_WECHATPAY_MCH_SERIAL_NO,
                OOS_SECRET_WECHATPAY_PRIVATE_KEY_PATH);
        List<String> valueList = Arrays.asList(
                OOS_ALIPAY_APP_ID,
                OOS_ALIPAY_PID,
                OOS_ALIPAY_GATEWAY,
                OOS_ALIPAY_SIGNATURE_METHOD,
                OOS_WECHATPAY_APP_ID,
                OOS_WECHATPAY_MCH_ID,
                OOS_WECHATPAY_GATEWAY);
        putSecretValueList(secretValueList);
        putValueList(valueList);

        modifiableParameterList = Arrays.asList(
                OOS_ALIPAY_APP_ID,
                OOS_ALIPAY_PID,
                OOS_ALIPAY_GATEWAY,
                OOS_SECRET_ALIPAY_OFFICIAL_PUBLIC_KEY,
