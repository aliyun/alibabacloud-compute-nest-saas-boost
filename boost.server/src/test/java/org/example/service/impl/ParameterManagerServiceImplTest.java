...
public class ParameterManagerServiceImplTest {
    ...
    void testListConfigParametersWithNullResponse() {
        ...
        assertNull(actualListResult); // Assert that the service returns a non-null ListResult object.
    }
    ...
    void testUpdateConfigParameterWithNullResponse() {
        ...
        assertNull(actualResult); // Assert that the service returns a non-null BaseResult object.
    }
}