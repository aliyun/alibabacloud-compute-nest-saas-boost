...
public class CertificateController {
    ...
    @ApiOperation(value = "查询证书列表", nickname = "listCerts")
    @RequestMapping(value = "/listCerts", method = RequestMethod.POST)
    public ListResult<String> listCerts(@ApiIgnore @AuthenticationPrincipal UserInfoModel userInfoModel,
                                        @RequestBody PayChannel payChannel) {
        return certificateService.listCerts(userInfoModel, payChannel);
    }
