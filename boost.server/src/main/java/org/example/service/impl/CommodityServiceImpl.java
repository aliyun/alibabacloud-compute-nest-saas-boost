...
public class CommodityServiceImpl implements CommodityService {
    @Override
    public BaseResult<CommodityDTO> createCommodity(CreateCommodityParam commodityDTO) {
        return null;
    }

    @Override
    public BaseResult<CommoditySpecificationDTO> createCommoditySpecification(CreateCommoditySpecificationParam specificationDTO) {
        return null;
    }
    ...
    @Override
    public BaseResult deleteCommodity(CommodityBaseParam commodityCode) {
        return null;
    }
    ...
    @Override
    public BaseResult<CommoditySpecificationDTO> updateCommoditySpecification(String commodityCode, CommoditySpecificationDTO specificationDTO) {
        return null;
    }

    @Override
    public BaseResult deleteCommoditySpecification(CommoditySpecificationParam specificationName) {
        return null;
    }
}
